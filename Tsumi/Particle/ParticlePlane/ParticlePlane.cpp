...
/// 描画処理
/// </summary>
void ParticlePlane::Draw(uint32_t texHD, Particle* pParticle, list<ParticleProperties> prope, Camera* camera) {
...
// ビルボードの処理
Matrix4x4 ParticlePlane::CalcBillBord(Camera* camera)
{
